...
/*	 for(int index = 0 ;index < 500 ;index ++){
		 ...
		 for(int i=0;i<100000;i++){
			 list.add(new mvcController().toString());
		 }
		 ...
		 for(int i=0;i<100000;i++){
			 list1.add(new mvcController().toString());
		 }
		 Long endTime1 = System.currentTimeMillis();
		 System.out.println((endTime-startTime) + "--第"+index+"次--" + (endTime1-startTime1));
	 }*/
	...
	/* HashMap map = new HashMap();
	 ...
	 System.out.println(map.get(5).hashCode());*/
